...
a = [1,2,3]
b = a[:] # 전체를 가리키는 [:]를 이용하여 복사(a의 복사한 값을 b에 넣어준다.)
a[1] = 4
print(a)
print(b) # 1,2,3 이 출력
...
# import sys + 자료형에 대한 참조 개수를 알려주는 sys.getrefcount를 이용
a = 3
print(sys.getrefcount(3)) # 처음에 a=3 하나만 대입했을때 54,
d = 3
print(sys.getrefcount(3)) # d=3까지 대입하면 55,
e = 3
print(sys.getrefcount(3)) # e=3까지 대입하면 56이ㅣ 출력된다.
